...
$ma=mysql_query("SELECT * FROM users where id='$id' ");  
  if(mysql_num_rows($ma)>0) {
    ...
    $message='hello'.' '.$name.' Your Appointment on date '.$_SESSION['date'].' at '.$_SESSION['time'].' has been booked successfully';
...
if (confirm("Appointment booked successfully. You will recieve a confirmation mesage shortly. Do you want to log out?") == true) {
