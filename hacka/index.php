...
<html>
	<head>
		<title>MIGORI COUNTY SURVEILLANCE SYSTEM</title>
	...
	<body>
		<!--start-wrap-->
			...
			<div class="header">
				...
				<!--start-logo-->
				<div class="logo">
					<a href="index.html" style="font-size: 30px;">MIGORI COUNTY SURVEILLANCE SYSTEM</a>
				</div>
				<!--end-logo-->
				<!--start-top-nav-->
				<div class="top-nav">
			...
			<!--start-image-slider---->
					<div class="image-slider">
					    ...
					    <ul class="rslides" id="slider1">
					      <li><img src="images/hack.png" alt=""></li>
